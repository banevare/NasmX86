...
The [test](https://en.wikipedia.org/wiki/Software_testing) cases are run by the [githubaction](https://github.com/philiprbrenan/NasmX86/blob/main/.github/workflows/main.yml#L54) at
