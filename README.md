...
The [test](https://en.wikipedia.org/wiki/Software_testing) cases are run by the [ [GitHub Action](https://docs.github.com/en/free-pro-team@latest/actions/quickstart) ](https://github.com/philiprbrenan/NasmX86/blob/main/.github/workflows/main.yml#L54) at
[this](https://github.com/philiprbrenan/NasmX86/blob/ca87d729f32a89cbbe97d5ce9112f9cf614ccb23/.github/workflows/main.yml#L54.) [step](http://docs.oasis-open.org/dita/dita/v1.3/errata02/os/complete/part3-all-inclusive/contentmodels/cmlts.html#cmlts__step). 
