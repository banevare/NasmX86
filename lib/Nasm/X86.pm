...
Print the memory addressed by rax for a length of rdi on sterr
...
184 L<PrintErrMemory|/PrintErrMemory> - Print the memory addressed by rax for a length of rdi on sterr
