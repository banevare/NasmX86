...
sub ClassifyNewLines(@)                                                         # A new line acts a semi colon if it appears immediately after a variable.
 {my (@parameters) = @_;                                                        # Parameters
  ...
  my %l = $Nida_Lexical_Tables->{lexicals}->%*;                                 # Lexical types
   ...
   {my ($p) = @_;                                                               # Parameters
    ...
    $$p{size}->for(sub                                                          # Each character in expression
     {my ($index, $start, $next, $end) = @_;
      ...
      NidaLexType r13;                                                          # Classify lexical type of current character
...
if (1) {                                                                        # Parse some code
  ...
  my $lex = $Nida_Lexical_Tables;                                               # Load lexical definitions
